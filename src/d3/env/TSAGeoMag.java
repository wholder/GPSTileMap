...
//
// 12-16-2015 - Modified version created to ermove unneeded code and data
//              for use in GPSTileMap and using updated WMM.COF file downlaoded
//              from: https://www.ngdc.noaa.gov/geomag/WMM/soft.shtml
//
////////////////////////////////////////////////////////////////////////////
...
public class TSAGeoMag {
  ...
  public static void main (String[] args) throws Exception {
    ...
    System.out.println(magModel.getDeclination(40.071000, -105.229500, 2015, 0));   // AVC 8.68
    System.out.println(magModel.getDeclination(32.919083, -117.114692, 2015, 0));   // ERMA 11.80
  }
   ...
   * file properly.
   */
  public TSAGeoMag () throws Exception {
   ...
   */
    ...
    InputStream input = getClass().getResourceAsStream("/declination/WMM.COF");
    if (input == null)
   ...
   *
   * @param  glat      The latitude in decimal degrees.
   * @param  glon      The longitude in decimal degrees.
   * @param  year      The date as a decimal year.
   * @param  alt       The altitude in kilometers.
   */
  private void calcGeoMag (double glat, double glon, double year, double alt) {
   ...
   */
  public double getDeclination (double dlat, double dlon, double year, double alt) {
    calcGeoMag(dlat, dlon, year, alt);
    return dec;
  }
   ...
   * @param  alt    Altitude of the calculation in kilometers.
   * @return Magnetic field strength in nano Tesla.
   */
  public double getIntensity (double dlat, double dlon, double year, double alt) {
    calcGeoMag(dlat, dlon, year, alt);
    return ti;
  }
}
